...
<ParamField path="param" body="{" type="string" required deprecated placeholder="teasdasd">
  Enter a asdasdasasdas
</ParamField>


<Expandable title="Content">
  <ResponseField name="response" type="stringasdasdasdasdasdasnbjkjknkjnjknkjkjnkjnjknjknjknkj" default="kjjkjkjkjknkjn" required={false} deprecated={false}>
    asEnter a description 
  </ResponseField>
</Expandable>
